...
class PerformancesControllerTest < ActionController::TestCase
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post :create, performance: { content: @performance.content, image: @performance.image, title: @performance.title }
    end
  ...
  test "should update performance" do
    patch :update, id: @performance, performance: { content: @performance.content, image: @performance.image, title: @performance.title }
    assert_redirected_to performance_path(assigns(:performance))
  end
